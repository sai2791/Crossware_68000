...
subroutine(0x805c, "help_service_call_skip_spaces")
subroutine(0x807c, "help_service_call_not_CR")
labelword(0x37, "ptr_1")
comment(0x8097, "end of the command table reached", align=Align.AFTER_LINE)
subroutine(0x80b8, "address_not_text")
subroutine(0x80a9, "find_end_of_text")
subroutine(0x808b, "check_if_command_entered")
immaddr(0x80ca, 0x80c3)
comment(0x80c2, "crossware_68000_cmd - 1", align=Align.AFTER_LINE)
word(0x9fd7,2)
label(0xa63a, "text_table")
entry(0x86b7, "code_to_copy")
label(0x46c, "copied_code")
subroutine(0x86ab, "copy_code_to_page_04")
subroutine(0x86a9, "copy_rom_code_to_046c")
subroutine(0x86c4, "error_missing_endif")
subroutine(0x95d4, "error_invalid_forcing")
entry(0x9549)
subroutine(0x8591, "increment_ptr2")
label(0x0b, "ptr_2")
subroutine(0x859b, "increment_ptr2_not_page_boundary")
subroutine(0x8814, "error_syntax_error")
subroutine(0x8803, "error_duplicate_label")
subroutine(0x87f4, "error_invalid_label")
label(0x8943, "text_opcode")
label(0x85ad, "update_ind1v")
label(0xff48, "E_IND1V")
string(0xa91e)
nonentry(0xa91e)
subroutine(0xa91b, "text_embeded_line_number_not_found")
entry(0xa94d)
subroutine(0xa950, "write_byte_to_file_handle_2")
subroutine(0xa95b, "close_file_handle_2")
labelword(0x600, "osfind_block")
subroutine(0xa871, "end_of_auto_new")
label(0x52, "character_read_from_rom")
label(0x53, "rom_to_read_from")
byte(0x844d, 0x84cb-0x0844d)
label(0x824a, "l824a")
entry(0x8e44)
subroutine(0x957e, "error_missing_comma")
subroutine(0x958d, "error_invalid_size_specification")
subroutine(0x95a9, "error_invalid_address_mode")
entry(0x95c8)
